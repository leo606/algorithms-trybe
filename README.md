...
Nesse projeto foi praticado os seguintes conceitos:
...
No projeto, foi praticado resolução de problemas e otimização de código, que envolve algumas habilidades:
